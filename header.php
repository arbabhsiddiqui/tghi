            ...
            <ul class="navbar-nav ml-auto ">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu  bg-dropdown" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="big.php">biginner course</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="intermidate.php">intermediate course</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="advance.php">advance coures</a>
             </li>
             <li class="nav-item">
